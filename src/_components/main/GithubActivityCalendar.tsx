    ...
    return (
        <>
            <Skeleton
                classNames={{
                    base: `w-full ${
                        isLoading ? "rounded-xl h-[140px] md:h-[180px]" : ""
                    }`,
                }}
                isLoaded={!isLoading}
            >
                <div
                    className={`md:border md:rounded-xl md:dark:border-primary md:p-6`}
                >
                    {filteredContributions && (
                        <>
                            <ActivityCalendar
                                ...
                                hideTotalCount
                            />
                            <div className="absolute bottom-0 text-[10px] hidden sm:block md:bottom-6">
