...
export default function ContactSection() {
    ...
    async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        await sendMessage(formData.current.value).then(({ error }) => {
            if (!error) {
                    ...
                    <div className="col-span-12 md:col-span-6 space-y-4 xl:col-span-5">
                        <div className="relative">
                            ...
                            >
                                <div className="p-5 xl:p-10 rounded-xl text-start relative">
                                    <TypewriterEffect
                                        words={typewriterEffectWords}
                                        cursorClassName="hidden"
                                    />
                                    <p className="mt-4 text-xs md:text-sm">
                                        Considering to be in contact with me
                                        regarding a project? Perhaps
                                        collaboration? Or just about anything?
                                    </p>
                                </div>
                            </MovingBorder>
                        </div>
                        ...
                        <div className="relative hidden md:block ">
                            ...
                            <div className="border p-5 xl:p-10 rounded-xl bg-background space-y-4 text-xs md:text-sm dark:border-default">
                                <p className="">
                                    I have worked on several freelance projects,
                                    ranging from capstone projects to
                                    enterprise-level tasks. I’m eager to take on
                                    more opportunities to help clients by
                                    delivering software solutions tailored to
                                    their needs. I am confident that I have the
                                    skills to take on any challenging job that
                                    matches my interest.
                                </p>
                                <p className="">
                                    Sincerely, a broke ass matcha-powered
                                    programmer badly in need of money hehe.
                                </p>
                    ...
                    <div className="col-span-12 relative">
                        ...
                        <div className="border p-5 xl:p-10 rounded-xl bg-background space-y-4 text-xs block md:hidden dark:border-default">
                            <p className="">
                                ...
                                ranging from capstone projects to
                                enterprise-level tasks. I’m eager to take on
                                more opportunities to help clients by delivering
                                software solutions tailored to their needs. I am
                                confident that I have the skills to take on any
                                challenging job that matches my interest.
                            </p>
                            <p className="">
                                Sincerely, a broke ass matcha-powered programmer
                                badly in need of money hehe.
                            </p>
                            <div className="flex items-center gap-4 text-primary">
                                <MapPin size={18} />
                                <p className="font-bold">
