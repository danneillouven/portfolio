    ...
    return (
        ...
        >
            ...
            <BentoBox className="dark:bg-foreground dark:text-background ">
                <div className="">
                    <p className="text-xs md:text-sm">
                        Based in the Philippines, I’m a 21-year-old final-year
                        student majoring in Information Technology with a
                        specialization in Software Development.
                        <span className="font-semibold">
                            {
                                " Being someone with almost unsatiable curiosity, "
                            }
                        </span>
                        I have quite the knack for studying topics that is
                        subject even outside the field of software development,
                        such as society, puzzles, mathematics, and music.
            ...
            {fieldInterests &&
                fieldInterests.map((fieldInterest, index) => (
                    <FieldInterestCard
            ...
            <div className="columns-2 space-y-4 sm:columns-1">
                {socials &&
                    socials.map((social, index) => (
                        <SocialCard key={`SocialCard-${index}`} {...social} />
                    ))}
            </div>
        </div>
    );
